<template>
	...
	<view>
		...
		<view class="membership-card">
			<!-- start 会员卡头部背景图片 -->
			<img class="membership-card-header-bak" src="@/static/images/membership-card-header-bak.png" />
			<!-- end 会员卡头部背景图片 -->
			<!-- start 会员卡头部内容 -->
			<view class="membership-card-header-content">
				...
				<view class="membership-card-header-bottom-bak">
					<img class="membership-card-header-bottom-icon"
					...
					<view class="membership-card-header-bottom-content">
						...
						<view class="membership-card-header-vip-info">
							<view class="user-vip-validity">
								<img class="warning-icon" src="@/static/images/warning-icon.png" />
			...
			<view class="menu-content">
				...
				<view class="show-message">
					<view class="show-message-list">
						<img class="show-message-list-icon" src="@/static/images/coupon-icon.png" />
						<view class="show-message-list-title">优惠券</view>
						<view class="show-message-list-count">10(张)</view>
					</view>
					<view class="show-message-list">
						<img class="show-message-list-icon" src="@/static/images/integral-icon.png" />
						<view class="show-message-list-title">积分</view>
						<view class="show-message-list-count">1250</view>
					</view>
					<view class="show-message-list">
						<img class="show-message-list-icon" src="@/static/images/shop-icon.png" />
